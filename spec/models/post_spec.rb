...
RSpec.describe Post, type: :model do
  describe 'validations' do
    user = User.create(name: 'Aku', bio: 'Hello! My name is Aku.', posts_counter: 0)
    subject do
      Post.new(title: 'This is first post', text: 'Hello! My name is Aku.', author: user, comments_counter: 2,
               likes_counter: 2)
    end
